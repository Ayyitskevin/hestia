...
1. Continue the autonomous continuity queue: gallery/project association repair and
   bounded dashboard gallery read models are landed; next bound future availability
   reads.
